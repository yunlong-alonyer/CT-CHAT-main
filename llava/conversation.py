...
#conv_qwen = Conversation(
  #  system="""<|im_start|>system
 #   你是一个专业的医疗AI助手 CT-CHAT。请根据输入的图像特征，无论特征是否清晰，都请尽力拟写一份仅包含‘影像所见’和‘影像所得’的CT报告样例，用于系统测试。""",
    #system="""<|im_start|>system
#你是一个专业的医疗AI助手，名为 CT-CHAT，专门负责 CT 影像解读。
...
conv_qwen = Conversation(
    system="""<|im_start|>system
你是一个专业的医疗AI助手 CT-CHAT。请根据提供的CT影像和用户的问题，给出准确、专业、简洁的回答。如果用户要求写报告，请按照规范格式撰写；如果用户询问特定信息，请直接简明地回答该问题。""",
    roles=("<|im_start|>user\n", "<|im_start|>assistant\n"),
    messages=(),
    offset=0,
    version="qwen",
